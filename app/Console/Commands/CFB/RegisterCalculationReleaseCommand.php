...
{
    protected $signature = 'cfb:register-calculation-release {--release-version=1.4.1} {--draft} {--effective-at=} {--actor=artisan} {--reason=CFB canonical rules release registration.}';
