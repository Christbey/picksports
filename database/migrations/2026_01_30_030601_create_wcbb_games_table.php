...
return new class extends Migration
{
    ...
    {
        Schema::create('wcbb_games', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('home_team_id')->constrained('wcbb_teams')->onDelete('cascade');
            $table->foreignId('away_team_id')->constrained('wcbb_teams')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('wcbb_games');
    }
};
