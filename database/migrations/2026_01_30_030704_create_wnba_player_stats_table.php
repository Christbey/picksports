...
return new class extends Migration
{
    ...
    {
        Schema::create('wnba_player_stats', function (Blueprint $table) {
            $table->id();
            $table->foreignId('player_id')->constrained('wnba_players')->onDelete('cascade');
            $table->foreignId('game_id')->constrained('wnba_games')->onDelete('cascade');
            $table->foreignId('team_id')->constrained('wnba_teams')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('wnba_player_stats');
    }
};
