...
return new class extends Migration
{
    ...
    {
        Schema::create('wnba_predictions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->unique()->constrained('wnba_games')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('wnba_predictions');
    }
};
