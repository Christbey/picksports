...
use App\Http\Controllers\Api\NFL\EloRatingController;
use App\Http\Controllers\Api\NFL\GameController;
use App\Http\Controllers\Api\NFL\PlayController;
use App\Http\Controllers\Api\NFL\PlayerController;
use App\Http\Controllers\Api\NFL\PlayerStatController;
use App\Http\Controllers\Api\NFL\PredictionController;
use App\Http\Controllers\Api\NFL\TeamController;
use App\Http\Controllers\Api\NFL\TeamMetricController;
use App\Http\Controllers\Api\NFL\TeamStatController;
...
// Team Metrics
Route::middleware('web')->apiResource('team-metrics', TeamMetricController::class)->only(['index', 'show']);
Route::middleware('web')->get('teams/{team}/metrics', [TeamMetricController::class, 'byTeam']);
