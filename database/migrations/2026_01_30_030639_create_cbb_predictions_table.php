...
return new class extends Migration
{
    ...
    {
        Schema::create('cbb_predictions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->unique()->constrained('cbb_games')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('cbb_predictions');
    }
};
