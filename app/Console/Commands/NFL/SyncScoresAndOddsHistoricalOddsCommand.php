...
{
    protected $signature = 'nfl:sync-scoresandodds-historical-odds
    ...
    protected $description = 'Sync historical NFL odds from ScoresAndOdds closing lines';
    ...
    public function handle(SyncHistoricalOddsForGames $action): int
    {
        ...
        $this->info('Syncing historical NFL odds from ScoresAndOdds...');
