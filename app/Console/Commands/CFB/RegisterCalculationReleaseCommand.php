...
{
    protected $signature = 'cfb:register-calculation-release {--release-version=1.6.3} {--draft} {--effective-at=} {--actor=artisan} {--reason=CFB canonical rules release registration.}';
