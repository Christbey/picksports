...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\CBB\TournamentForecast>
 */
class CbbTournamentForecastFactory extends Factory
{
    protected $model = \App\Models\CBB\TournamentForecast::class;
