...
{
    protected string $sport = 'basketball_wnba';
    ...
    {
        $oddsData = $this->oddsApiService->getWnbaOdds();
    ...
    protected function fuzzyMatchTeams(Game $game, array $event): bool
    {
        ...
        // WNBA teams use city/location names like NBA
        ...
        // Try matching with city/location names
