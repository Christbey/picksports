...
return new class extends Migration
{
    ...
    {
        Schema::create('cfb_players', function (Blueprint $table) {
            $table->id();
            $table->string('espn_id', 50)->unique();
            $table->foreignId('team_id')->nullable()->constrained('cfb_teams')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('cfb_players');
    }
};
