...
return new class extends Migration
{
    ...
    {
        Schema::create('cfb_games', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('home_team_id')->constrained('cfb_teams')->onDelete('cascade');
            $table->foreignId('away_team_id')->constrained('cfb_teams')->onDelete('cascade');
