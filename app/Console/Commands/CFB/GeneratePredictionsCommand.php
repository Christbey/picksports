...
{
    protected $signature = 'cfb:generate-predictions
    ...
    protected $description = 'Generate CFB game predictions based on Elo ratings and team metrics';
    ...
    protected function displayPrediction(Prediction $prediction): void
    {
        ...
        $this->table(
            ...
            [
                ...
                ['Home Off Rating', round($prediction->home_off_rating, 1)],
                ['Home Def Rating', round($prediction->home_def_rating, 1)],
                ['Away Off Rating', round($prediction->away_off_rating, 1)],
                ['Away Def Rating', round($prediction->away_def_rating, 1)],
