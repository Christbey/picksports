...
class CalculateTeamTrends
{
     ...
     */
    public function execute(Team $team, int $gameCount = 16, ?int $season = null, ?string $beforeDate = null, string $userTier = 'free'): array
    {
        ...
        foreach ($this->collectors as $collectorClass) {
            ...
            $collector->setContext('nfl', $team, $games);
