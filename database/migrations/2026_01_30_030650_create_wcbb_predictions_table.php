...
return new class extends Migration
{
    ...
    {
        Schema::create('wcbb_predictions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->unique()->constrained('wcbb_games')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('wcbb_predictions');
    }
};
