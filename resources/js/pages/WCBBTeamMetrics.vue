...
const fetchMetrics = async () => {
    try {
        ...
        const response = await fetch('/api/v1/wcbb/team-metrics');
...
<template>
    <Head title="WCBB Team Metrics" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">WCBB Team Metrics</h1>
            ...
            <SubscriptionBanner variant="subtle" storage-key="wcbb-metrics-banner-dismissed" />
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="p-2 font-medium">
                                        <Link
                                            :href="WCBBTeamController(metric.team.id)"
