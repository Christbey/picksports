...
{
    private const TOTAL_GAME_SECONDS = 2400; // 4 quarters * 10 minutes * 60 seconds

    private const SECONDS_PER_QUARTER = 600; // 10 minutes
    ...
    protected function calculateLiveTotal(int $currentTotal, int $secondsElapsed, int $secondsRemaining, float $preGameTotal): float
    {
        ...
        // Apply bounds (WNBA games typically score between 140-200 total points)
        return max($currentTotal, min(250, $liveTotal));
    }
