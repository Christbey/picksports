        ...
        <CardContent>
            ...
            <div v-else-if="allTrendCategories.length > 0" class="space-y-6">
                ...
                <div
                    ...
                    class="rounded-xl border border-emerald-300/60 bg-emerald-500/10 p-4 backdrop-blur-sm dark:border-emerald-800/50 dark:bg-emerald-500/12"
                >
                    <h4
                        class="mb-2 text-sm font-semibold text-emerald-800 dark:text-emerald-300"
                    >
                        Top Matchup Edges
                    </h4>
                ...
                >
                    <div class="mb-3 flex items-center justify-between gap-2">
                        ...
                        <Badge variant="outline" class="text-[11px]">
                            {{
                                (awayTrends?.trends?.[category]?.length || 0) +
                                (homeTrends?.trends?.[category]?.length || 0)
                            }}
                            signals
                        </Badge>
                    </div>
                    ...
                    <div
                        ...
                        class="rounded-lg border border-zinc-200/70 bg-zinc-50 py-4 text-center dark:border-zinc-800 dark:bg-zinc-900/70"
                    >
                    ...
                    <div v-else class="grid gap-3 md:grid-cols-2">
                        <div
                            class="rounded-lg border border-border/70 bg-muted/35 p-3"
                        >
