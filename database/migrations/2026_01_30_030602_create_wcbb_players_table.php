...
return new class extends Migration
{
    ...
    {
        Schema::create('wcbb_players', function (Blueprint $table) {
            $table->id();
            $table->string('espn_id', 50)->unique();
            $table->foreignId('team_id')->nullable()->constrained('wcbb_teams')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('wcbb_players');
    }
};
