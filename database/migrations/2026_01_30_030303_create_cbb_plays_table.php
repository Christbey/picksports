...
return new class extends Migration
{
    ...
    {
        Schema::create('cbb_plays', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->constrained('cbb_games')->onDelete('cascade');
            ...
            $table->foreignId('possession_team_id')->nullable()->constrained('cbb_teams')->onDelete('set null');
            $table->timestamps();
