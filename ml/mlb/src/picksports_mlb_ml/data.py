...
class DatasetIntegrityError(RuntimeError):
    """Raised when an immutable export changes while it is being consumed."""
...
def load_immutable_dataset(
    ...
    if expected_sha256 and hash_before != expected_sha256.lower():
    ...
    if sha256_file(resolved) != hash_before:
