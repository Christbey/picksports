...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('cbb_predictions', $columns);
        Schema::table('wcbb_predictions', $columns);
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('cbb_predictions', function (Blueprint $table) use ($dropColumns) {
            $table->dropColumn($dropColumns);
        });

        Schema::table('wcbb_predictions', function (Blueprint $table) use ($dropColumns) {
            $table->dropColumn($dropColumns);
        });
    }
};
