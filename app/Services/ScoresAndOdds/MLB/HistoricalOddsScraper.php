...
{
    private const SPORT_PATH = '/mlb';

    private const DETAIL_PATH = '/mlb/events/%s/details';
    ...
    public function parseEventDetails(string $html, string $eventId): ?array
    {
        ...
        $awayMoneyline = $this->parseOddsValue($this->bookCellValue($xpath, $moneylineRows[0], $draftKingsColumn, 'data-moneyline'));
        $homeMoneyline = $this->parseOddsValue($this->bookCellValue($xpath, $moneylineRows[1], $draftKingsColumn, 'data-moneyline'));
