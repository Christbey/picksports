...
<template>
    <Card>
        ...
        <CardContent>
                    ...
                    <tbody class="text-sm">
                        <tr class="border-b">
                            ...
                            <td
                                ...
                                :class="
                                    props.getBetterValue(
                                        homeTeamStats.field_goals_made,
                                        awayTeamStats.field_goals_made,
                                    ) === 'away'
                            ...
                            >
                                {{ awayTeamStats.field_goals_made }}-{{
                                    awayTeamStats.field_goals_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        awayTeamStats.field_goals_made,
                            ...
                            >
                                {{ homeTeamStats.field_goals_made }}-{{
                                    homeTeamStats.field_goals_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        homeTeamStats.field_goals_made,
                        ...
                        <tr class="border-b">
                            ...
                            <td
                                ...
                                :class="
                                    props.getBetterValue(
                                        homeTeamStats.three_point_made,
                                        awayTeamStats.three_point_made,
                                    ) === 'away'
                                        ? 'text-green-600 dark:text-green-400'
                                        : ''
                                "
                            >
                                {{ awayTeamStats.three_point_made }}-{{
                                    awayTeamStats.three_point_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        awayTeamStats.three_point_made,
                            ...
                            >
                                {{ homeTeamStats.three_point_made }}-{{
                                    homeTeamStats.three_point_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        homeTeamStats.three_point_made,
                        ...
                        <tr class="border-b">
                            ...
                            <td
                                ...
                                :class="
                                    props.getBetterValue(
                                        homeTeamStats.free_throws_made,
                                        awayTeamStats.free_throws_made,
                                    ) === 'away'
                                        ? 'text-green-600 dark:text-green-400'
                                        : ''
                                "
                            >
                                {{ awayTeamStats.free_throws_made }}-{{
                                    awayTeamStats.free_throws_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        awayTeamStats.free_throws_made,
                            ...
                            >
                                {{ homeTeamStats.free_throws_made }}-{{
                                    homeTeamStats.free_throws_attempted
                                }}
                                ({{
                                    calculatePercentage(
                                        homeTeamStats.free_throws_made,
            ...
            <div
                v-else
                class="space-y-4 rounded-xl border border-border/70 p-3"
            >
                <div
                    class="grid grid-cols-7 gap-2 border-b pb-2 text-sm font-medium"
                >
                ...
                <div class="grid grid-cols-7 items-center gap-2 text-sm">
                    <div
                        ...
                        :class="
                            props.getBetterValue(
                                homeTeamStats.points_in_paint ?? 0,
                                awayTeamStats.points_in_paint ?? 0,
                            ) === 'away'
                                ? 'text-green-600 dark:text-green-400'
                                : ''
                        "
                ...
                <div class="grid grid-cols-7 items-center gap-2 text-sm">
                    <div
                        ...
                        :class="
                            props.getBetterValue(
                                homeTeamStats.fast_break_points ?? 0,
                                awayTeamStats.fast_break_points ?? 0,
                            ) === 'away'
                                ? 'text-green-600 dark:text-green-400'
                                : ''
                        "
