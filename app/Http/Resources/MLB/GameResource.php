...
class GameResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'home_starting_pitcher_candidates' => $this->resource->startingPitcherCandidates('home'),
            'away_starting_pitcher_candidates' => $this->resource->startingPitcherCandidates('away'),
            'home_expected_starting_pitcher_rating' => $this->resource->expectedStartingPitcherRating('home'),
            'away_expected_starting_pitcher_rating' => $this->resource->expectedStartingPitcherRating('away'),
            'home_starting_pitcher_uncertainty' => $this->resource->startingPitcherUncertainty('home'),
            'away_starting_pitcher_uncertainty' => $this->resource->startingPitcherUncertainty('away'),
