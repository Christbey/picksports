...
return new class extends Migration
{
    ...
    {
        Schema::create('cbb_player_stats', function (Blueprint $table) {
            $table->id();
            $table->foreignId('player_id')->constrained('cbb_players')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('cbb_player_stats');
    }
};
