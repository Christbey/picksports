...
namespace App\Actions\ScoresAndOdds\NFL;
...
class SyncHistoricalOddsForGames
{
    ...
    public function execute(
        ...
        foreach ($games as $game) {
            ...
            if ($matchedEvent === null) {
                $unmatchedGames[] = $this->unmatchedGameRow($game, $dateKey);
    ...
    /**
     * @return array{game_id:int,game_date:string,game_time:?string,home_team:string,away_team:string}
     */
    private function unmatchedGameRow(Game $game, string $dateKey): array
    {
        return [
