...
import NflPlayerPropCard from '@/components/player-props/NflPlayerPropCard.vue';
        ...
        <div class="mx-auto w-full max-w-7xl space-y-6 p-3 md:p-4">
            <div class="space-y-2">
                ...
                <p class="text-muted-foreground">
                    {{
                        sport === 'NFL'
                            ? 'The pick, the price, and how often it covered this line.'
                            : description
                    }}
                </p>
            </div>
            ...
            <template v-else>
                <div
                    v-if="sport === 'NFL'"
                    class="grid grid-cols-1 items-start gap-4 md:grid-cols-2 xl:grid-cols-3"
                >
                    <NflPlayerPropCard
