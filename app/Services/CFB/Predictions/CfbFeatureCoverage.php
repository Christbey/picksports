...
class CfbFeatureCoverage
{
    public static function describe(array $inputs, bool $fpiBaseline, ?string $pairedRating): array
    {
        ...
        return [
            ...
            'personnel' => ['home' => data_get($inputs, 'home.personnel'),
                'away' => data_get($inputs, 'away.personnel'),
                'role' => 'evidence_gate_and_shadow_covariates_not_unvalidated_point_adjustment'],
