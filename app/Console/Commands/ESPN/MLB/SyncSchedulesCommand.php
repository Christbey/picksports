...
{
    protected $signature = 'espn:sync-mlb-schedules
                            {--season=2025 : The season year}
                            {--team= : Specific team ESPN ID (optional, syncs all teams if not provided)}';

    protected $description = 'Sync MLB team schedules from ESPN API';
    ...
    public function handle(): int
    {
        ...
        $this->info("Syncing schedules for {$totalTeams} MLB teams (Season {$season})...");
