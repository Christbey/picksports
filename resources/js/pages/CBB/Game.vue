    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <template v-else>
                        ...
                        <div class="flex items-center justify-between gap-6">
                            ...
                            >
                                <div class="text-right">
                                    ...
                                    <div v-if="awayRecentForm" class="text-xs text-muted-foreground mt-1">
                                        {{ awayRecentForm }}
                                    </div>
                            ...
                            >
                                ...
                                <div class="text-left">
                                    ...
                                    <div v-if="homeRecentForm" class="text-xs text-muted-foreground mt-1">
                                        {{ homeRecentForm }}
                                    </div>
                ...
                <Card v-if="game.status === 'STATUS_FINAL' && (game.venue || broadcastNetworks.length > 0)">
                    <CardHeader>
                        <CardTitle>Game Details</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div v-if="game.venue" class="text-center p-4 bg-muted/50 rounded-lg">
                                <div class="text-sm text-muted-foreground">Venue</div>
                                <div class="text-lg font-medium">{{ game.venue }}</div>
                            </div>
                            <div v-if="broadcastNetworks.length > 0" class="text-center p-4 bg-muted/50 rounded-lg">
                                <div class="text-sm text-muted-foreground">Broadcast</div>
                                <div class="text-lg font-medium">{{ broadcastNetworks.join(', ') }}</div>
                            </div>
                            <div v-if="game.season" class="text-center p-4 bg-muted/50 rounded-lg">
                                <div class="text-sm text-muted-foreground">Season</div>
                                <div class="text-lg font-medium">{{ game.season_type }} - Week {{ game.week }}</div>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b">
                                        ...
                                        <th v-for="(_, index) in Math.max(homeLinescores.length, awayLinescores.length)" :key="index" class="text-center p-2">
                                            H{{ index + 1 }}
                                        </th>
                                ...
                                <tbody>
                                    <tr class="border-b">
                                        <td class="p-2 font-medium">{{ awayTeam?.abbreviation || 'Away' }}</td>
                                    ...
                                    <tr>
                                        <td class="p-2 font-medium">{{ homeTeam?.abbreviation || 'Home' }}</td>
