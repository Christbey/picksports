...
class SyncTeams
{
    ...
    public function execute(): int
    {
        ...
        foreach ($teams as $teamData) {
            ...
            try {
                ...
                Log::warning("CBB: Skipping team {$team['id']} due to connection timeout", [
                    'team_id' => $team['id'],
                    'error' => $e->getMessage(),
                ]);
    ...
    {
        $url = "https://sports.core.api.espn.com/v2/sports/basketball/leagues/mens-college-basketball/groups/{$conferenceId}";
    ...
    {
        $url = "https://sports.core.api.espn.com/v2/sports/basketball/leagues/mens-college-basketball/groups/{$divisionId}";
