...
return new class extends Migration
{
    ...
    {
        Schema::create('wcbb_plays', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('possession_team_id')->nullable()->constrained('wcbb_teams')->onDelete('set null');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('wcbb_plays');
    }
};
