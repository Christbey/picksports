...
Learned diagnostic statistics are rounded to six decimal places before freezing them in JSON. This preserves snapshot and prediction hashes across the production database JSON round trip. Evidence caches are isolated by calculation release version.
