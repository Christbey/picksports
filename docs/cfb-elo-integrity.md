# CFB Elo integrity and canonical release 1.4.1
...
6. Register canonical release 1.4.1, atomically retire the previous approved CFB pregame release, and run `cfb:run-pregame-pipeline`. There must be exactly one approved pregame release. Preserve prior forecasts and their input snapshots.
