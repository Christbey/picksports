...
return new class extends Migration
{
    ...
    {
        Schema::create('cbb_games', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('home_team_id')->constrained('cbb_teams')->onDelete('cascade');
            $table->foreignId('away_team_id')->constrained('cbb_teams')->onDelete('cascade');
