...
class CalculateTeamMetricsCommand extends Command
{
    ...
    protected $description = 'Calculate NFL team metrics (offensive/defensive ratings, yards, turnovers, SOS)';
    ...
    public function handle(): int
    {
        ...
        if ($teamId = $this->option('team')) {
            ...
            $this->info("Calculating metrics for {$team->city} {$team->name} ({$season})...");
