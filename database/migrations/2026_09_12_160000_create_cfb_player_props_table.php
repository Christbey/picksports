...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('cfb_player_props')) {
            return;
        }

        Schema::create('cfb_player_props', function (Blueprint $table): void {
            $table->id();
            ...
            $table->string('quote_key', 64)->nullable()->unique();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('cfb_player_props');
    }
};
