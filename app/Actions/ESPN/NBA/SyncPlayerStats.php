    ...
    public function execute(array $gameData, Game $game): int
    {
        ...
        foreach ($gameData['boxscore']['players'] as $teamData) {
            ...
            foreach ($athletes as $athleteData) {
                ...
                // Stats come as strings: ["27", "11", "3-10", "0-3", "5-6", "3", "5", "6", "1", "0", "1", "2", "3", "-23"]
                // Index mapping based on the keys array we saw:
                // 0: minutes, 1: points, 2: FG, 3: 3PT, 4: FT, 5: REB, 6: AST, 7: TO, 8: STL, 9: BLK, 10: OREB, 11: DREB, 12: PF
