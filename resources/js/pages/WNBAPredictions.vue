...
import WNBAPredictionsComponent from '@/components/WNBAPredictions.vue';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { wnbaPredictions, responsibleGambling } from '@/routes';
import { type BreadcrumbItem } from '@/types';

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'WNBA Predictions',
        href: wnbaPredictions().url,
    },
];
</script>

<template>
    <Head title="WNBA Predictions" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <SubscriptionBanner variant="subtle" storage-key="wnba-predictions-banner-dismissed" />
