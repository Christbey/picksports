...
class MlbPickPromotionGate
{
     ...
     */
    public function apply(string $internalLabel, string $marketType): array
    {
        if (! $this->validationGate->allowsPublicPromotion($marketType)) {
            return [
                ...
                'is_bet' => false,
                'blocked_reasons' => $this->validationGate->blockedReasons($marketType),
            ];
        }
