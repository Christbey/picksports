...
class PlayoffForecastResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'division_win_probability' => (float) ($this->division_win_probability ?? 0),
            'division_series_probability' => (float) ($this->division_series_probability ?? 0),
            'league_championship_series_probability' => (float) ($this->league_championship_series_probability ?? 0),
            'league_championship_probability' => (float) $this->league_championship_probability,
            'pennant_probability' => (float) ($this->pennant_probability ?? $this->league_championship_probability),
