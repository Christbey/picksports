...
{
    protected $signature = 'cfb:register-calculation-release {--release-version=1.4.0} {--draft} {--effective-at=} {--actor=artisan} {--reason=CFB canonical rules release registration.}';
