...
return new class extends Migration
{
    ...
    {
        Schema::create('cfb_player_stats', function (Blueprint $table) {
            $table->id();
            $table->foreignId('player_id')->constrained('cfb_players')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('cfb_player_stats');
    }
};
