...
use App\Actions\ESPN\WNBA\SyncPlayerInjuries;
...
class FetchPlayerInjuries implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($this->teamEspnId) {
            ...
            Log::info("WNBA: Synced {$count} player injuries for team {$this->teamEspnId} from ESPN");
        } else {
            $count = $action->syncAllTeams();
            Log::info("WNBA: Synced {$count} total player injuries from ESPN");
        }
    }
}
