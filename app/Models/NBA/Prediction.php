...
class Prediction extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'home_injuries_out' => 'integer',
            'away_injuries_out' => 'integer',
            'home_injuries_questionable' => 'integer',
            'away_injuries_questionable' => 'integer',
            'injury_spread_adj' => 'decimal:2',
            'injury_total_adj' => 'decimal:2',
