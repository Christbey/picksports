...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\WCBB\TeamStat>
 */
class WcbbTeamStatFactory extends Factory
{
    protected $model = \App\Models\WCBB\TeamStat::class;
