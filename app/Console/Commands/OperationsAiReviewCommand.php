...
class OperationsAiReviewCommand extends Command
{
    ...
    private function compactFacts(array $facts): array
    {
        $keys = [
            ...
            'sample_expected_missing_required_market_game_ids',
            ...
            'secondary_markets_unavailable_far_games',
            'secondary_markets_unavailable_soft_window_games',
            'secondary_markets_unavailable_expected_window_games',
