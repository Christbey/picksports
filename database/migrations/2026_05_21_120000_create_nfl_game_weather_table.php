...
return new class extends Migration
{
    ...
    {
        Schema::create('nfl_game_weather', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->unique()->constrained('nfl_games')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('nfl_game_weather');
    }
};
